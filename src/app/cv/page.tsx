...
export default function CVPage() {
  return (
    ...
    <div className="fixed inset-0 z-[60] w-full h-full overflow-y-auto bg-neutral-100 dark:bg-[#0a0a0a] transition-colors duration-500 print:static print:overflow-visible print:bg-white">
      ...
      <div className="relative min-h-screen py-12 px-4 flex justify-center print:p-0 print:m-0 print:block print:min-h-0">
        ...
        <div className="w-full max-w-[210mm] min-h-[297mm] bg-white dark:bg-[#111] text-slate-800 dark:text-slate-300 shadow-2xl dark:shadow-[0_0_50px_rgba(0,0,0,0.5)] dark:border dark:border-white/10 p-10 md:p-14 print:shadow-none print:border-none print:w-full print:max-w-none print:p-[40px] print:bg-white print:text-black transition-colors duration-500">
          ...
          <header className="border-b-2 border-slate-900 dark:border-white/20 pb-8 mb-8 flex flex-col md:flex-row print:flex-row justify-between items-start print:border-black print:break-inside-avoid">
            ...
            <div className="flex flex-col gap-2 mt-6 md:mt-0 print:mt-0 text-sm font-medium text-slate-600 dark:text-slate-400 print:text-slate-700 text-right print:text-right print:items-end">
              ...
              <a href="https://portfolio-wheat-nine-50.vercel.app/" target="_blank" className="flex items-center justify-end gap-2 hover:text-blue-600 dark:hover:text-blue-300 transition-colors">
          ...
          <section className="mb-8 print:break-inside-avoid">
            ...
            <p className="text-base md:text-lg leading-relaxed text-slate-700 dark:text-slate-300 print:text-slate-800">
              <span className="font-bold text-slate-900 dark:text-white print:text-black">Impact-driven Data Scientist & Engineer</span> with a unique ability to bridge the gap between complex statistical modeling and production-grade web applications. 
          ...
          {/* --- SKILLS GRID --- */}
          <section className="mb-8 p-5 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/10 print:bg-transparent print:border print:border-slate-300 print:p-2 print:break-inside-avoid">
            <h2 className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-4 border-b border-slate-200 dark:border-white/10 pb-2 print:text-slate-600 print:border-slate-300">
              Core Competencies
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 print:grid-cols-3 gap-6">
              <div>
                <h3 className="font-bold text-sm text-slate-900 dark:text-white mb-2 flex items-center gap-2 print:text-black">
                  Data Intelligence
                </h3>
                <ul className="text-xs text-slate-600 dark:text-slate-400 print:text-slate-700 space-y-1 font-medium">
          ...
          {/* --- PROJECTS --- */}
          <section className="mb-8 print:break-inside-avoid">
            <h2 className="text-xl font-serif font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-3 print:text-black">
              Personal Projects
            ...
            <div className="space-y-5">
              <div className="print:break-inside-avoid">
                <div className="flex justify-between items-baseline mb-1">
                  <h3 className="text-base font-bold text-slate-900 dark:text-white print:text-black">
                    Project Nostro <span className="text-xs font-normal text-slate-500 dark:text-slate-400 ml-1 print:text-slate-600">| Full Stack Restaurant Management Web App</span>
                  </h3>
              ...
              <div className="print:break-inside-avoid">
                <div className="flex justify-between items-baseline mb-1">
                  <h3 className="text-base font-bold text-slate-900 dark:text-white print:text-black">
                    Driveflow <span className="text-xs font-normal text-slate-500 dark:text-slate-400 ml-1 print:text-slate-600">| Car Rental System (Not yet Deployed)</span>
                  </h3>
                  <span className="text-xs font-mono text-blue-600 dark:text-blue-400 print:text-black">2025</span>
                </div>
                <ul className="list-disc list-inside text-sm text-slate-700 dark:text-slate-300 space-y-1 print:text-slate-800">
                 ...
                 {/* <li>Optimized inference speed to achieve <strong>30 FPS</strong> on edge devices.</li> */}
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8 print:break-inside-avoid">
            ...
            <div className="space-y-6">
              <div className="pl-4 border-l-2 border-slate-200 dark:border-white/10 print:border-slate-300 print:break-inside-avoid">
                <div className="flex justify-between items-baseline mb-1">
                  <h3 className="font-bold text-slate-900 dark:text-white print:text-black">IT Support Intern</h3>
                  <span className="text-xs font-mono text-slate-500 dark:text-slate-400 print:text-black">The National Treasury | 2024</span>
                </div>
                <ul className="list-disc list-inside text-sm text-slate-700 dark:text-slate-300 space-y-1 print:text-slate-800">
              ...
              <div className="pl-4 border-l-2 border-slate-200 dark:border-white/10 print:border-slate-300 print:break-inside-avoid">
                <div className="flex justify-between items-baseline mb-1">
                  <h3 className="font-bold text-slate-900 dark:text-white print:text-black">Volunteer</h3>
                  <span className="text-xs font-mono text-slate-500 dark:text-slate-400 print:text-black">Tuwakuze Africa | 2022</span>
                </div>
                <ul className="list-disc list-inside text-sm text-slate-700 dark:text-slate-300 space-y-1 print:text-slate-800">
                  {/* <li><strong>Spearheaded</strong> digital literacy workshops for 50+ community members, improving local tech adoption.</li> */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-8 print:gap-4 print:break-inside-avoid">
            <section className="print:break-inside-avoid">
              ...
              <div>
                <h3 className="font-bold text-slate-900 dark:text-white print:text-black">BSc. Data Science & Analytics</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400 print:text-slate-700">JKUAT</p>
                <p className="text-xs font-mono text-slate-500 dark:text-slate-500 mt-1 print:text-slate-600">
            ...
            <section className="print:break-inside-avoid">
              ...
              <div>
                <h3 className="font-bold text-slate-900 dark:text-white print:text-black flex items-center gap-2">
                  President's Award <span className="text-xs font-normal text-slate-500 dark:text-slate-400">(Silver)</span>
                </h3>
                <p className="text-xs text-slate-600 dark:text-slate-400 print:text-slate-700 mt-1">
                  Awarded for leadership and community service excellence in High School Club activities.
                </p>
              </div>*/}
            </section>
          </div> 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-8">
              ...
              <div className="text-sm text-slate-700 dark:text-slate-300 text-center">
                ...
                <p className="font-mono text-xs mt-1 text-blue-600 dark:text-blue-400 print:text-black">
                  Phone: +254 741 887 744
                </p>
                <p className="font-mono text-xs text-slate-500">
                  Email: muyajoseph@gmail.com
                </p>
              </div>
